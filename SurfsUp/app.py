...
def welcome():
    ...
    return (
        ...
        f'<br/>'
        f'Precipitation Analysis for last 12 months:<br/>'
        f'/api/v1.0/precipitation<br/>'
        f'Stations:<br/>'
        f'/api/v1.0/stations<br/>'
        f'Temperature observations for the previous year:<br/>'
        f'/api/v1.0/tobs<br/>'
        f'Min, Avg, Max temperatures for specified start date:<br/>'
        f'/api/v1.0/(start date)<br/>'
        f'Min, Avg, Max temperatures for start - end range:<br/>'
        f'/api/v1.0/(start date)/(end date)<br/>'
        f'(Note: date format of YYYY-MM-DD for the start and end dates)'
    )
